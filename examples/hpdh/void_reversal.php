...
$iso->setField(4, str_pad(980000, 12, 0, STR_PAD_LEFT));
$iso->setField(11, '000065');
$iso->setField(12, '102732');
$iso->setField(13, '1128');
$iso->setField(14, '2007');
$iso->setField(22, '0111');
$iso->setField(24, '0009');
$iso->setField(25, '00');
$iso->setField(37, '000000000064');
...
$packed = "003860000900000410303801000A8000000200000000009800000000651029131128000932383131313830303030363530303938373039383033";
