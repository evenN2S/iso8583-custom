...
$iso->setField(70, '0301');

$packed = $iso->pack();

# DEBUG
$output[] = "# PACKING `echo` REQUEST";
...
$packed = "00236000000000081082200000020000000400000000000000120409245700000130300301";
$unpacked = $iso->unpack($packed);

# DEBUG
$output[] = "# UNPACKING `echo` RESPONSE";
$output[] = "- ISO MESSAGE  : " . $packed;
$output[] = "- LENGTH       : " . $iso->getLengthString();
$output[] = "- TPDU         : " . $iso->getTPDU();
$output[] = "- MTI          : " . $iso->getMTI();
